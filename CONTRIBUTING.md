...
2. Clone your fork:
   ```bash
   git clone https://github.com/YOUR_USERNAME/bootstrap-app.git
   cd bootstrap-app
   ```
...
- Open a [Discussion](https://github.com/bodhiapps/bootstrap-app/discussions)
- Review existing [Issues](https://github.com/bodhiapps/bootstrap-app/issues)
