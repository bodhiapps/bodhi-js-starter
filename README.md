...
[![CI](https://github.com/bodhiapps/bootstrap-app/actions/workflows/ci.yml/badge.svg)](https://github.com/bodhiapps/bootstrap-app/actions/workflows/ci.yml)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![Deploy](https://github.com/bodhiapps/bootstrap-app/actions/workflows/deploy-pages.yml/badge.svg)](https://github.com/bodhiapps/bootstrap-app/actions/workflows/deploy-pages.yml)

🚀 **[Live Demo](https://bodhiapps.github.io/bootstrap-app/)**
...
git clone https://github.com/bodhiapps/bootstrap-app.git
cd bootstrap-app
...
Visit `http://localhost:5173/bootstrap-app/` to view the app.
...
**Via CLI:**
```bash
gh api -X POST "/repos/bodhiapps/bootstrap-app/pages" -f build_type=workflow
```
...
The app is deployed to: `https://bodhiapps.github.io/bootstrap-app/`
